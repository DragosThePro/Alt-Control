	...
	if player.Name == _G.controller then
		...
		elseif message == ".L" then
			...
			elseif game.Players.LocalPlayer.Name == alts.alt2 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(-4, 0, -1)
			elseif game.Players.LocalPlayer.Name == alts.alt3 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(8, 0, 1)
			elseif game.Players.LocalPlayer.Name == alts.alt4 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(-8, 0, -1)
			elseif game.Players.LocalPlayer.Name == alts.alt5 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(16, 0, 1)
			elseif game.Players.LocalPlayer.Name == alts.alt6 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(-16, 0, -1)
			elseif game.Players.LocalPlayer.Name == alts.alt7 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(20, 0, 1)
			elseif game.Players.LocalPlayer.Name == alts.alt8 then
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = game.Players[_G.controller].Character:WaitForChild("HumanoidRootPart").CFrame * CFrame.new(-20, 0, -1)
			elseif game.Players.LocalPlayer.Name == alts.alt9 then
		...
		elseif message == ".removewhite" then
			chat("Removing white screen, This might make you lag.")
